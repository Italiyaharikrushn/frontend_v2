...
import { LayoutDashboard, Package, ShoppingBag, Truck, Users, LogOut, X, Tag, RotateCcw, FileText, IndianRupee, BarChart2, Star, Briefcase, Wallet } from 'lucide-react';
  ...
  return (
    <aside className={`sidebar ${isMobileOpen ? 'mobile-open' : ''}`}>
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/admin/deliveries" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`} onClick={handleNavClick}>
          <Truck size={20} />
        ...
        <NavLink to="/admin/cost-management" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`} onClick={handleNavClick}>
          <Wallet size={20} />
        ...
        <NavLink to="/admin/about-us" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`} onClick={handleNavClick}>
          <Briefcase size={20} />
          <span>About Us</span>
        </NavLink>
      </nav>
