...
import '@/styles/pages/storefront/Products.css'; // Reuse product grid styles
...
const Favorites = () => {
    ...
    if (isLoading) {
        return (
            <div className="storefront-container" style={{ minHeight: '60vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
